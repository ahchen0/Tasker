...
class GeoStarMenuBar(tk.Frame):
    """Creates the menubar for use in the GeoStar GUI.
    ...
    def fileOpen(self):
        ...
        if(len(name)>0):
            ...
            self.event_publish(["GeoStarMenuBar::fileOpen",name])
    ...
    def viewZoomin(self):
        self.event_publish(["GeoStarMenuBar::viewZoomIn"])

    def viewZoomout(self):
        self.event_publish(["GeoStarMenuBar::viewZoomOut"])

    def viewPan(self):
        self.event_publish(["GeoStarMenuBar::viewPan"])

    def viewInverted(self):
        self.event_publish(["GeoStarMenuBar::viewInverted"])

    def helpVersion(self):
        messagebox.showinfo("Version","GeoStar GUI Version 0.0.1")

...
class GeoStarTreeView(tk.Frame):
        """
        ...
        def fileMenu(self,  choice=None, iid=None):
                ...
                if choice == "close":
                        ...
                        self.event_publish(["GeoStarTreeView::fileClose",file_name])
                        print("event published:"+"GeoStarTreeView::fileClose, filename="+file_name)
        ...
        def raster_menu_select(self, selfmb=None, iid=None, image=None, choice=None):
                ...
                for menu in menus:
                        ...
                        if theiid != iid:
                                ...
                                if choice == "gray" or choice =="pct":
                                        ...
                                        self.event_publish(["GeoStarTreeView::state","raster::blank",raster_name, image_name, file_name])
                ...
                parent = self.treeview.parent(parent)
                file_name   = self.item_text(self.treeview.item(parent,option="values"))
                self.event_publish(["GeoStarTreeView::raster_menu_select",choice,raster_name, image_name, file_name])
                print("event published:"+"GeoStarTreeView::raster_menu_select"+", "+choice+", "+raster_name+", "+ image_name+", "+ file_name)
                return

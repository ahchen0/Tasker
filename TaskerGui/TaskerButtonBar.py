...
class TaskerButtonBar(tk.Frame):
    ...
    def fileCreate(self):
        self.event_publish(["TaskerButtonBar::fileCreate"])
    ...
    def fileOpen(self):
        ...
        if(len(name)>0):
            ...
            self.event_publish(["TaskerButtonBar::fileOpen",name])
    
    def zoomIn(self):
        self.event_publish(["TaskerButtonBar::viewZoomIn"])
    
    def zoomOut(self):
        self.event_publish(["TaskerButtonBar::viewZoomOut"])

    def redo(self):
        self.event_publish(["TaskerButtonBar::redo"])

    def undo(self):
        self.event_publish(["TaskerButtonBar::undo"])

    def createHistogram(self):
        self.event_publish(["TaskerButtonBar::histogram"])
    ...
    def plot(self):
        self.event_publish(["TaskerButtonBar::plot"])

    def settings(self):
        self.event_publish(["TaskerButtonBar::settings"])
